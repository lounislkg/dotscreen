...
playAgainButton === null || playAgainButton === void 0 ? void 0 : playAgainButton.addEventListener('click', resetGame);
//créer la grille
let colonnes = [];
let currentPlayer = "x";
let canPlay = true;
...
function createGrid() {
    ...
    for (let i = 0; i < 7; i++) {
        ...
        main === null || main === void 0 ? void 0 : main.appendChild(colonne);
    }
}
function Play(colmun_id) {
